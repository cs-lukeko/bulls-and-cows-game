...
public class Game {
    ...
    public void start() {
        ...
        while (true) {
            try {
                ...
                gameMode = GameUtils.selectMode(Keyboard.readInput());
                ...
                for (int i = 0; i < players.length; i++) {
                        ...
                        while (true) {
                            ...
                            if (currentGuesser.getGuess().isValidCode()) {
                                ...
                                if (currentGuesser instanceof AIMedium) {
                                    AIMedium aiMedium = (AIMedium) currentGuesser; // cast currentGuesser to AIMedium to access its previousGuesses array
                                    while (true) {
                                ...
                                if (currentGuesser.getAttempts() == MAX_ATTEMPTS && i == 1) { // i == 1 ensures both players get a final turn before declaring a loss
                                    ...
                                    resultsFile.append("It was a draw! Neither player guessed the secret code. :|");
                                }
                                break playerTurn;
                            } else {
                                System.out.println("Please try again.");
    ...
    public void saveGame(ResultsFile resultsFile) {
        String saveYOrN;
        String fileName;
